...
public:
	...
	const FGameplayTag& GetStatusFortitudeTag() const { return ResolveTag(StatusFortitudeTag, LabGameplayTags::Status_Resistance_Fortitude); }
	const FGameplayTag& GetStatusSanityTag() const { return ResolveTag(StatusSanityTag, LabGameplayTags::Status_Resistance_Sanity); }
	...
	const FGameplayTag& GetStatusCriticalChanceTag() const { return ResolveTag(StatusCriticalChanceTag, LabGameplayTags::Status_Agility_CriticalChance); }
...
private:
	...
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "!Tags|Status", meta = (Categories = "Status.Defense", AllowPrivateAccess = "true"))
	FGameplayTag StatusMagicResistanceTag;

	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "!Tags|Status", meta = (Categories = "Status.Resistance", AllowPrivateAccess = "true"))
	FGameplayTag StatusImmunityTag;

	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "!Tags|Status", meta = (Categories = "Status.Resistance", AllowPrivateAccess = "true"))
	FGameplayTag StatusFortitudeTag;

	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "!Tags|Status", meta = (Categories = "Status.Resistance", AllowPrivateAccess = "true"))
	FGameplayTag StatusSanityTag;
	...
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "!Tags|Status", meta = (Categories = "Status.Agility", AllowPrivateAccess = "true"))
	FGameplayTag StatusCriticalChanceTag;
