...
#include UE_INLINE_GENERATED_CPP_BY_NAME(GrappleTargetActor)

AGrappleTargetActor::AGrappleTargetActor(const FObjectInitializer& ObjectInitializer)
...
void AGrappleTargetActor::StartTargeting(UGameplayAbility* Ability)
{
	Super::StartTargeting(Ability);
	SourceActor = Ability ? Ability->GetAvatarActorFromActorInfo() : nullptr;
}

void AGrappleTargetActor::ConfirmTargetingAndContinue()
{
