...
#include "GroundTargetActor.generated.h"
...
class LABPROJECT_API AGroundTargetActor : public AGameplayAbilityTargetActor_GroundTrace
{
	GENERATED_BODY()
...
public:
	// Public API ------------------------------------------------------------------------------------------------------
	AGroundTargetActor(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
