...
AProjectileBase* USkillProjectileCastAction::SpawnPreparedSocketBarrageProjectile(const FName SocketName)
{
...
void USkillProjectileCastAction::LaunchSocketBarrageProjectile(AProjectileBase* Projectile)
{
