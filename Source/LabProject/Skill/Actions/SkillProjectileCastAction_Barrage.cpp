...
bool USkillProjectileCastAction::TryStartSocketBarrage(const FVector TargetLocation)
{
    ...
    for (const TObjectPtr<ASkillProjectile>& Projectile : SocketBarrageProjectiles)
    {
...
ASkillProjectile* USkillProjectileCastAction::SpawnPreparedSocketBarrageProjectile(const FName SocketName)
{
    ...
    const TSubclassOf<ASkillProjectile> ConfiguredProjectileClass = Settings.ProjectileActorClass;
...
void USkillProjectileCastAction::LaunchSocketBarrageProjectile(ASkillProjectile* Projectile)
{
...
FVector USkillProjectileCastAction::ResolveSocketBarrageLaunchTargetLocation(const FVector& ProjectileLocation) const
{
...
FVector USkillProjectileCastAction::ResolveCharacterTargetSocketProjectileTargetLocation(const FVector& FromLocation) const
{
...
void USkillProjectileCastAction::FireNextSocketBarrageProjectile()
{
    ...
    ASkillProjectile* Projectile = SocketBarrageProjectiles.IsValidIndex(NextSocketBarrageProjectileIndex)
...
void USkillProjectileCastAction::ClearSocketBarrageState(const bool bDestroyPendingProjectiles)
{
    if (UWorld* World = GetWorld())
    {
    ...
    {
       for (ASkillProjectile* Projectile : SocketBarrageProjectiles)
       {
...
bool USkillProjectileCastAction::IsSocketBarrageActive() const
{
