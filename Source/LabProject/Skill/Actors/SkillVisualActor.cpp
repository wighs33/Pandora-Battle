...
#include UE_INLINE_GENERATED_CPP_BY_NAME(SkillVisualActor)
...
ASkillVisualActor::ASkillVisualActor()
{
	bReplicates = true;
...
bool ASkillVisualActor::HasAnyPresentation() const
{
	return PresentationFlags != static_cast<uint8>(ESkillPresentationFlags::None);
}

void ASkillVisualActor::BeginPlay()
{
	Super::BeginPlay();
...
void ASkillVisualActor::Tick(const float DeltaSeconds)
{
	Super::Tick(DeltaSeconds);
	UpdateLocalMissileTargets();
}

void ASkillVisualActor::EndPlay(const EEndPlayReason::Type EndPlayReason)
{
	if (HasAuthority() && IsValid(SourceCharacter))
	{
...
void ASkillVisualActor::OnRep_PresentationState()
{
	RefreshLocalPresentation();
}

void ASkillVisualActor::HandleSourceDestroyed(AActor* DestroyedActor)
{
...
void ASkillVisualActor::RefreshLocalPresentation()
{
...
void ASkillVisualActor::CleanupLocalPresentation()
{
	StopMissiles();
	StopCharacterOverlay();
	StopGroundFX();
...
void ASkillVisualActor::StartDefaultFX()
{
...
void ASkillVisualActor::StopDefaultFX()
{
	ACharacterBase* Character = ResolveSourceCharacter();
...
void ASkillVisualActor::StopGroundFX()
{
	if (!LocalDefaultGroundNiagaraComponent)
	{
		return;
...
void ASkillVisualActor::StopCharacterOverlay()
{
...
void ASkillVisualActor::RefreshLocalMissiles()
{
...
void ASkillVisualActor::StopMissiles()
{
...
void ASkillVisualActor::UpdateLocalMissileTargets()
{
	for (int32 Index = LocalMissileTargetActors.Num() - 1; Index >= 0; --Index)
	{
...
ACharacterBase* ASkillVisualActor::ResolveSourceCharacter() const
{
...
void ASkillVisualActor::SetMissileTargeting(FName InAimParameter, FName InTargetSocket)
{
