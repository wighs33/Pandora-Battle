...
#include "SkillEffectArea.generated.h"
...
class LABPROJECT_API ASkillEffectArea : public AActor
{
	GENERATED_BODY()
...
public:
	// Public API ------------------------------------------------------------------------------------------------------
	ASkillEffectArea(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
