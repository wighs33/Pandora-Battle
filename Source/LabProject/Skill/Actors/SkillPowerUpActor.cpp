...
#include UE_INLINE_GENERATED_CPP_BY_NAME(SkillPowerUpActor)

ASkillPowerUpActor::ASkillPowerUpActor()
{
...
void ASkillPowerUpActor::BeginPlay()
{
	Super::BeginPlay();
...
void ASkillPowerUpActor::Tick(const float DeltaSeconds)
{
...
void ASkillPowerUpActor::OnRep_Owner()
{
	Super::OnRep_Owner();
...
void ASkillPowerUpActor::OnRep_Instigator()
{
...
UNiagaraComponent* ASkillPowerUpActor::FindNiagaraComponentByName(const FName ComponentName) const
{
...
AWeaponBase* ASkillPowerUpActor::ResolveCurrentWeapon(const ACharacterBase* Character) const
{
...
void ASkillPowerUpActor::ApplyEffectAlpha(const float Alpha)
{
...
void ASkillPowerUpActor::RestoreSourcePlayerState()
{
...
void ASkillPowerUpActor::OnRep_PresentationSettings()
{
	if (!HasActorBegunPlay())
	{
		return;
